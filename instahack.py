...
def brute_force_real():
    ...
    try:
        ...
        print(f"\033[1;31m[!] Error reading file: {e}")
        return

    matrix_scan(f"[*] Starting Brute-Force Payload on @{target}...")
    for pwd in passwords:
        sys.stdout.write(f"\r\033[1;37m[ATTEMPT] \033[1;31m@{target} \033[1;37m| Key: \033[1;33m{pwd.ljust(15)} \033[1;37m| Status: \033[1;31mDENIED")
        sys.stdout.flush()
        time.sleep(0.04)
        # هذا الشرط للمحاكاة كما في كودك الأصلي
        if pwd == "abood123":
...
def main():
    while True:
        ...
        if choice in ['1', '01']: get_ultra_data()
            ...
            print("\033[1;31mShutting down system... Goodbye Abood.")
            sys.exit()
